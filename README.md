# Yandex Alice AI — Safety Filter Bypass via Combined Obfuscation

> **Bug Bounty Write-up** | Responsible Disclosure | May 2026  
> **Researcher:** Umid N. | [github.com/umid1988](https://github.com/umid1988)
...
| Field | Value |
|-------|-------|
| **Target** | alice.yandex.ru |
| **Report ID** | YA-2025-002 |
| **Date** | 2026-05-20 |
| **Severity** | HIGH |
| **CVSS 3.1** | 7.3 — `AV:N/AC:L/PR:N/UI:N/S:U/C:H/I:L/A:N` |
| **Status** | Reported → Forwarded to Alice AI team |
...
*© 2026 Umid N. | [github.com/umid1988](https://github.com/umid1988) | AI Security Research*
